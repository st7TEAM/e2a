...
class DeliteAddons(Screen):
	...
	def KeyOk(self):
		...
		if self.sel == 0:
			...
			staturl = "http://www.dreambox-community.net/bhaddons/index.php?op=outmestats2"
...
class Nab_downArea(Screen):
	...
	def updateList(self):
		...
		mypixmap = mypath + "icons/nabcams.png"
		png = LoadPixmap(mypixmap)
		name = "Dream Elite E2 Image Cams"
		idx = 0
		res = (name, png, idx)
		self.list.append(res)
	...
	def KeyOk(self):
		...
		self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Cams"
		self.title = "Black Hole Cams"
		
		if self.sel == 1:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Plugins"
			self.title = "Black Hole Plugins"
		elif  self.sel == 2:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Skins"
			self.title = "Black Hole Skins"
		elif  self.sel == 3:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Scripts"
			self.title = "Black Hole Scripts"
		elif  self.sel == 4:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Langs"
			self.title = "Black Hole Languages"
		elif  self.sel == 5:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Settings"
			self.title = "Black Hole Settings"
		elif  self.sel == 6:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat&cat=Picons"
			self.title = "Black Hole Picons Packages"
		elif  self.sel == 7:
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outcat10_2"
...
class Nab_downCat(Screen):
	...
	def KeyOk(self):
		...
		if self.sel:
			...
			self.url = "http://www.dreambox-community.net/bhaddons/index.php?op=outfile&idf=" + self.myidf
...
class Nab_ShowDownFile(Screen):
	...
	def KeyGreend(self):
		self.url = '"http://www.dreambox-community.net/bhaddons/files/' + self.fileN + '"'
