...
class FPGAUpgrade(Screen):
	skin = """
		<screen position="center,center" size="560,440" title="FPGA Upgrade" >
			<ePixmap pixmap="skin_default/buttons/red.png" position="0,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="skin_default/buttons/green.png" position="140,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="skin_default/buttons/yellow.png" position="280,7" size="140,40" alphatest="blend" />
			<ePixmap pixmap="skin_default/buttons/blue.png" position="420,7" size="140,40" alphatest="blend" />

			<widget source="key_red" render="Label" position="20,7" zPosition="1" size="115,40" font="Regular;20" halign="center" valign="center" transparent="1" />
			<widget source="key_green" render="Label" position="160,7" zPosition="1" size="115,40" font="Regular;20" halign="center" valign="center" transparent="1" />
			<widget source="key_yellow" render="Label" position="300,7" zPosition="1" size="115,40" font="Regular;20" halign="center" valign="center" transparent="1" />
			<widget source="key_blue" render="Label" position="440,7" zPosition="1" size="115,40" font="Regular;20" halign="center" valign="center" transparent="1" />
